...
contract MockNFTFrontier is ERC1155 {
    string public name;
    ...
    constructor(address mintTo, uint id, uint num) ERC1155("") {
        name = "Frontier";
        symbol = "FRONTIER";
    ...
    function mint(address _to, uint256 _id, uint256 _amount) external adminOnly {
        _mint(_to, _id, _amount, "");
    }

    function mintBatch(address _to, uint256[] memory _ids, uint256[] memory _amounts) external adminOnly {
