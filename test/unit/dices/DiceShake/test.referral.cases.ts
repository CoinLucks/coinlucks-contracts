...
const assertFn = async (test: TestCaseType, fixture: any) => {
  const { diceShake, diceShakeVRF, referral, owner, deployArgs, accounts } = fixture;
...
describe("DiceShake Referral scenarios1", function () {
  let fixture: any;
  before(async () => {
...
describe("DiceShake Referral scenarios2", function () {
  let fixture: any;
  before(async () => {
    fixture = await loadFixture(deployFixture);
  });
