export const VRFCoordinatorContractABI = [
  {
    inputs: [{ internalType: "address", name: "blockhashStore", type: "address" }],
  ...
  {
    inputs: [
      { internalType: "uint96", name: "subAccountMaxDeposit", type: "uint96" },
      { internalType: "uint256", name: "oldSubBalance", type: "uint256" },
      { internalType: "uint96", name: "depositAmount", type: "uint96" },
    ],
    name: "ExceedingTheMaximumRechargeLimit",
    type: "error",
  },
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: "address", name: "proposedOwner", type: "address" }],
  ...
  { inputs: [{ internalType: "address", name: "owner", type: "address" }], name: "MustBeSubOwner", type: "error" },
  {
    ...
    name: "NoAuthFulfillRandomWords",
    type: "error",
  },
  { inputs: [], name: "NoCorrespondingRequest", type: "error" },
  { inputs: [{ internalType: "bytes32", name: "keyHash", type: "bytes32" }], name: "NoSuchProvingKey", type: "error" },
  {
    inputs: [
      { internalType: "uint32", name: "have", type: "uint32" },
      { internalType: "uint32", name: "want", type: "uint32" },
  ...
  { inputs: [], name: "TooManyConsumers", type: "error" },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: "uint16", name: "maxNumWords", type: "uint16" },
      { indexed: false, internalType: "uint32", name: "maxGasLimit", type: "uint32" },
      { indexed: false, internalType: "uint32", name: "gasAfterPaymentCalculation", type: "uint32" },
      { indexed: false, internalType: "uint96", name: "subAccountMaxDeposit", type: "uint96" },
      {
        components: [
          { internalType: "uint32", name: "fulfillmentFlatFeeBNBPPMTier1", type: "uint32" },
          { internalType: "uint32", name: "fulfillmentFlatFeeBNBPPMTier2", type: "uint32" },
          { internalType: "uint32", name: "fulfillmentFlatFeeBNBPPMTier3", type: "uint32" },
          { internalType: "uint32", name: "fulfillmentFlatFeeBNBPPMTier4", type: "uint32" },
          { internalType: "uint32", name: "fulfillmentFlatFeeBNBPPMTier5", type: "uint32" },
        ...
        indexed: false,
        internalType: "struct VRFCoordinatorContract.FeeConfig",
        name: "feeConfig",
        type: "tuple",
      },
    ],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, internalType: "address", name: "node", type: "address" }],
    name: "NodeAccessAdd",
    type: "event",
  },
  {
  ...
  },
  {
    ...
    name: "s_withdrawableTokensAddressChange",
    type: "event",
  },
  {
    inputs: [],
    name: "BLOCKHASH_STORE",
    outputs: [{ internalType: "contract BlockhashStoreInterface", name: "", type: "address" }],
  ...
  {
    inputs: [{ internalType: "uint256[2]", name: "publicProvingKey", type: "uint256[2]" }],
    ...
    inputs: [
      {
        components: [
          ...
          { internalType: "uint256[2]", name: "cGammaWitness", type: "uint256[2]" },
          { internalType: "uint256[2]", name: "sHashWitness", type: "uint256[2]" },
      ...
      },
      {
        ...
        internalType: "struct VRFCoordinatorContract.RequestCommitment",
        name: "rc",
        type: "tuple",
      },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint16", name: "maxNumWords", type: "uint16" },
  ...
  {
    inputs: [{ internalType: "uint64", name: "subId", type: "uint64" }],
    name: "getDesignatedSubIdFeeTier",
  ...
  {
    inputs: [],
    name: "getNodesWhiteListSwitchStatus",
    outputs: [{ internalType: "bool", name: "", type: "bool" }],
    stateMutability: "view",
    type: "function",
  },
  ...
  {
    inputs: [{ internalType: "uint256[2]", name: "publicKey", type: "uint256[2]" }],
    name: "hashOfKey",
    outputs: [{ internalType: "bytes32", name: "", type: "bytes32" }],
  ...
  },
  {
    inputs: [
      { internalType: "uint64", name: "subId", type: "uint64" },
      { internalType: "uint32", name: "feeTier", type: "uint32" },
    ],
    name: "setDesignatedSubIdFeeTier",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
  {
    ...
    name: "setNodesWhiteListSwitchStatus",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
